...
.nm{width:212px;flex-shrink:0;font-size:13px;display:flex;align-items:center;justify-content:flex-end;gap:0;white-space:nowrap;overflow:hidden}
...
function render(){
 ...
 function fmtMatch(mn){const s=SCHED[mn];return 'Match '+mn+' &middot; '+s[0]+(s[1]?', '+s[1]:'')+' &middot; '+s[2];}
 function fxline(p){
